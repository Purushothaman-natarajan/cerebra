...
export interface Run { id: string; workflow_id: string; status: string; started_at: string | null; finished_at: string | null; prompt_tokens: number; completion_tokens: number; total_tokens: number; cost: number; error?: string | null }
